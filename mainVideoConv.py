...
print("Эта программа распознает значение манометра с видео!")
...
img2 = frame
gaugeNumber = 1
min_value, max_value = text_recognition(frame)

Image, val = PressureGaugeCheck(frame, img2, min_angle, max_angle, min_value, max_value)
